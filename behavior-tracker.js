(() => {
  function loadScript(src,attr){
    if(window[attr] || document.querySelector(`script[data-${attr}]`)) return;
  ...
  loadScript('/i18n.js?v=20260904-1','nexora-i18n');
  loadScript('/i18n-settings.js?v=20260904-1','nexora-i18n-settings');
