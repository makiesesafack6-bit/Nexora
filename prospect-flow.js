(function(){
  ...
  function openProspect(i,provided){
    ...
    modal.querySelector('#copyMessage').onclick=()=>navigator.clipboard?.writeText('Bonjour '+p.name+', j’ai vu que vous recherchez '+String(p.need).toLowerCase()+'. Je peux vous aider sur ce projet. Seriez-vous disponible pour en discuter ?');
